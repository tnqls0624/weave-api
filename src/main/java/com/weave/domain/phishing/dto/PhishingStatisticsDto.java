...
public class PhishingStatisticsDto {
  ...
  public static PhishingStatisticsDto from(PhishingStatistics stats) {
    ...
    return PhishingStatisticsDto.builder()
      ...
      .totalScanned(stats.getTotalScanned())
      .phishingDetected(stats.getPhishingDetected())
      .highRiskCount(stats.getHighRiskCount())
      .mediumRiskCount(stats.getMediumRiskCount())
      .lowRiskCount(stats.getLowRiskCount())
      .autoBlockedCount(stats.getAutoBlockedCount())
      .falsePositiveCount(stats.getFalsePositiveCount())
      ...
      .detectionRate(stats.getDetectionRate())
